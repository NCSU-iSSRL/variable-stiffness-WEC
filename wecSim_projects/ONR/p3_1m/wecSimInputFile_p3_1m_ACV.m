...
simu.simMechanicsFile = 'plunger3_1m_ACV.slx';              % Simulink Model File
...
body(1).initial.displacement = [0 0 -4];
...
HP_unstretched_length = 6; % m
HP_unstretched_radius = 0.06;
HP_unstretched_fiber_angle = 1.1; % rad
...
if ~simSweep
    regulator_set_pressure_PSI = 14.4; % Pressure regulator setting
    G = 1;
