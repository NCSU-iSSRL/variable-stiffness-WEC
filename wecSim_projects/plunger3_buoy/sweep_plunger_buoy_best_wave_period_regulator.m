...
filename = sprintf('%s\\P3_sim_sweep_regulator_resultsOnly_%s.mat', dataSaveFolder, runTimeStamp);
...
if saveLargeData
    filename = sprintf('%s\\P3_sim_sweep_regulator_full_%s.mat', dataSaveFolder, runTimeStamp);
