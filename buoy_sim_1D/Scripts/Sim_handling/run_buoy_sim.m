% run_buoy_sim.m
% Script to handle running low-order Simulink buoy simulation and perform some data analysis. 
% C. McGuire

%% single sim run
clear;clc;
%%% params
% other params (buoy size, fluid density, etc..) are in model explorer
wave_amplitude = 15; % m
wave_period = 5; % s
spring_const = 100000; % N/m
damping = 120000; %N/(m/s)
